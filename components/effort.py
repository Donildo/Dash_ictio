                    ...
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H5(id="Subtext_1"),
                                            ...
                                            "box-shadow":"0 10px 10px 0 rgba(0,0,0,0.15), 0 4 px 20px 0 rgba(0,0,0.19)",
                                            "color":"#0A0A2A"})
                            ])]),
                dbc.Col([
                    dbc.Card([
        ...
        dbc.Col([
            dbc.Card([
                ...
                html.Div(
                 ...
                 html.Legend("Período de Análise", style={"margin-top": "60px"}),
                        dcc.DatePickerRange(
            ...
            dbc.Col(
                dbc.Card(dcc.Graph(figure = fig_bl4, id='graph1'), style={'height':'100%', 'padding':'15px'}), width=8
            )
        ], style={'margin': '60px'}),
        dbc.Row([
            dbc.Col(dbc.Card(dcc.Graph(figure = graph_progress, id='graph2'), style={'padding': '500x', 'margin':'65px'}), width=5),
            #dbc.Col(dbc.Card(dcc.Graph(id='graph3'), style={'padding':'margin':'65px' }), width=3),
            #dbc.Col(dbc.Card(dcc.Graph(id='graph4'), style={'padding':'margin':'65px'}), width=3),
        ])
    ])
